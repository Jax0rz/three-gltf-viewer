...
contentDiv.textContent = '你好'

let contentLabel = new CSS2DObject(contentDiv)
let labelPosition = new Vector3(3, 5, 3)
contentLabel.position.set(labelPosition.x, labelPosition.y, labelPosition.z)
...
export class Viewer {
    constructor(el, options) {
        ...
        this.labelRenderer.setSize(60, 30)
    ...
    setContent(object, clips) {
        ...
        if (this.options.cameraPosition) {
            ...
            this.defaultCamera.position.y += size / 1.0
    ...
    addLights() {
        ...
        if (this.options.preset === Preset.ASSET_GENERATOR) {
            ...
            this.lights.add(this.state, 'exposure', 1.1)
            this.lights.add(this.state, 'ambientIntensity', 1.6)
            this.lights.add(this.state, 'directIntensity', 0.01)
            return
        }
